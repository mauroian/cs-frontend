        ...
        <ul class="flex-row hidden md:flex cs-menu-level1">
            ...
            <li class="relative inline-block group">
                ...
                <ul
                    id="menu"
                    aria-hidden="true"
                    class="mx-auto text-sm tracking-widest cs-menu-level2">
                        ...
                        <li class="block cs-menu-logged-item cs-logged-nested">
                            <a href="#" class="w-full flex flex-row justify-between">
                                ...
                                <img src="src/assets/logged-arrow-down.svg"
                                    ...
                                    <ul class="overflow-hidden opacity-0  list-none hidden dropdown-menu">
    ...
    <div class="md:hidden fixed bg-cs-paper w-full z-20">
        ...
        <ul class="hidden overflow-hidden cs-mobile-menu ">
            ...
            <li class="flex flex-col items-center w-full group cs-menu-item">
                ...
                <ul
                    aria-hidden="true"
                    class="hidden opacity-0 w-full mx-auto text-sm tracking-widest cs-mobile-menu bg-cs-paper-shade">
                    ...
                    <li class="relative w-full cs-menu-item">
                        ...
                        <ul
                            aria-hidden="true"
                            class="hidden opacity-0 overflow-hidden border bg-cs-paper-dark cs-mobile-menu min-w-32 cs-inner">
            ...
            <li class="flex flex-col items-center w-full group cs-menu-item">
                ...
                <ul
                    id="menu-2"
                    aria-hidden="true"
                    class="hidden opacity-0  w-full mx-auto overflow-hidden text-sm tracking-widest cs-mobile-menu bg-cs-paper-shade">
                    <!-- L2 public menu item (mobile) -->
                    <li class="cs-menu-voice-item">
                        <a href="" class="flex items-center cs-menu-item">
                            <span class="cs-menu-item-span">Ascension Press</span>
