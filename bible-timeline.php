    ...
    <div class="cs-main-div">
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper">
            <div class=" relative w-full max-w-[1000px] my-10 flex flex-col gap-6">
                ...
                <div class="bg-contain bg-[url(/src/assets/bible-timeline/trail.svg)] pt-[36%] bg-no-repeat bg-[4rem]">
                    <p class="cs-fs-lg text-left -mt-4 w-[50%]">
        ...
        <div class=" flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper">
            <div class="relative w-full max-w-[1000px] mt-48 mb-5 flex flex-col gap-6 text-center items-center">
                ...
                <h2 class="relative font-sans font-bold cs-fs-xl md:cs-fs-3xl sm:cs-fs-2xl cs-gradient-text mt-4">We make the complex <br>simple.
                    <img src="/src/assets/bible-timeline/im-in.svg" class="absolute -right-4 w-48 top-20">
                </h2>
        ...
        <div class="grid grid-flow-row grid-cols-1 md:grid-cols-2 row-auto gap-5 max-w-[1000px]">
