            ...
            <div class="flex sm:flex-row flex-col w-full gap-2 py-10 items-center justify-start">
                ...
                <div class="ml-auto mt-2">
                    <button class="cs-testimonial-viewport-toggle" onclick="toggleViewport(1)">
                        ...
                        <svg viewBox="0 0 55 55" fill="#black" xmlns="http://www.w3.org/2000/svg" class="h-9 w-9 fill-cs-red-main border border-cs-red-main rounded-lg hidden">
                    ...
                    <button class="cs-testimonial-viewport-toggle" onclick="toggleViewport(2)"><svg class="w-9 h-9  fill-cs-red-main border border-cs-red-main rounded-lg stroke-cs-paper " viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg class="w-9 h-9 fill-cs-paper hidden" viewBox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
