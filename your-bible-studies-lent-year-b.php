        ...
        <div class="cs-main-div">
            ...
            <div class="flex flex-col items-center w-full py-5 pl-10 text-white sm:py-10 bg-cs-blue-light">
                <div class="w-full max-w-[1000px]">
                    ...
                    <h1 class="font-serif text-left sm:cs-fs-3xl cs-fs-2xl leading-[40px] mt-3 sm:mt-5">Lenten Sunday Gospels (Year B)</h1>
                </div>
            ...
            <div class="flex flex-col items-center cs-personal-area-container">
                ...
                <div class="cs-bible-area-box">
                    ...
                    <button type="button" onclick="toggleAccordion(this)"
                        ...
                        <div>
                            <div class=" text-cs-blue-light">First Sunday of Lent (Year&nbsp;B) - Mk&nbsp;1:12-15</div>
                            <div class="mt-2 italic cs-fs-sm text-cs-grey">
                                Jesus tempted in the desert by the devil
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cs-content">
                        ...
                        <div class="cs-bible-accordion-content">
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b">
                                ...
                                <a href="get-resources/lnt-b-s1-study-questions---1sun-lnt-b" class="flex flex-row mt-4">
                            ...
                            <!-- SHORT NOTES CONTAINER -->
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100">
                                ...
                                <a href="get-resource/lnt-b-s1-short-notes---1sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Short Notes
                                    </span>
                            ...
                            </div> <!-- END OF SHORT NOTES CONTAINER -->
                ...
                <div class="cs-bible-area-box">
                    ...
                    <button type="button" onclick="toggleAccordion(this)"
                        ...
                        <div>
                            <div class=" text-cs-blue-light">Second Sunday of Lent (Year&nbsp;B) - Mk&nbsp;9:2-10</div>
                            <div class="mt-2 italic cs-fs-sm text-cs-grey">
                                The Transfiguration
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cs-content">
                        ...
                        <div class="cs-bible-accordion-content">
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b cs-course-border-t">
                                ...
                                <a href="get-resource/lnt-b-s2-video----2sun-lnt-b" class="flex flex-row mt-0">
                                    <img src="/src/assets/video-icon.svg" class="inline-block w-8 h-8">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Video of Second Sunday of Lent
                                    </span>
                                </a>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b">
                                ...
                                <a href="get-resources/lnt-b-s2-study-questions---2sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Study Questions
                                    </span>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100">
                                ...
                                <a href="get-resource/lnt-b-s2-short-notes---2sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Short Notes
                                    </span>
                ...
                <div class="cs-bible-area-box">
                    ...
                    <button type="button" onclick="toggleAccordion(this)"
                        ...
                        <div>
                            <div class=" text-cs-blue-light">Third Sunday of Lent (Year&nbsp;B) - Jn&nbsp;2:13-25</div>
                            <div class="mt-2 italic cs-fs-sm text-cs-grey">
                    ...
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cs-content">
                        ...
                        <div class="cs-bible-accordion-content">
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b cs-course-border-t">
                                ...
                                <a href="get-resource/lnt-b-s3-video----3sun-lnt-b" class="flex flex-row mt-0">
                                    <img src="/src/assets/video-icon.svg" class="inline-block w-8 h-8">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Video of Third Sunday of Lent
                                    </span>
                                </a>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b">
                                ...
                                <a href="get-resources/lnt-b-s3-study-questions---3sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Study Questions
                                    </span>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100">
                                ...
                                <a href="get-resource/lnt-b-s3-short-notes---3sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Short Notes
                                    </span>
                ...
                <div class="cs-bible-area-box">
                    ...
                    <button type="button" onclick="toggleAccordion(this)"
                        ...
                        <div>
                            <div class=" text-cs-blue-light">Fourth Sunday of Lent (Year&nbsp;B) - Jn&nbsp;3:14-21</div>
                            <div class="mt-2 italic cs-fs-sm text-cs-grey">
                                Jesus proclaims the Good News to Nicodemus: light againts darkness
                            </div>
                        </div>
                    ...
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cs-content">
                        ...
                        <div class="cs-bible-accordion-content">
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b cs-course-border-t">
                                ...
                                <a href="get-resource/lnt-b-s4-video----4sun-lnt-b" class="flex flex-row mt-0">
                                    <img src="/src/assets/video-icon.svg" class="inline-block w-8 h-8">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Video of Fourth Sunday of Lent
                                    </span>
                                </a>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b">
                                ...
                                <a href="get-resources/lnt-b-s4-study-questions---4sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Study Questions
                                    </span>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100">
                                ...
                                <a href="get-resource/lnt-b-s4-short-notes---4sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Short Notes
                                    </span>
                ...
                <div class="cs-bible-area-box">
                    ...
                    <button type="button" onclick="toggleAccordion(this)"
                        ...
                        <div>
                            <div class=" text-cs-blue-light">Fifth Sunday of Lent (Year&nbsp;B) - Jn&nbsp;12:20-33</div>
                            <div class="mt-2 italic cs-fs-sm text-cs-grey">
                    ...
                    <!-- 5TH SUNDAY CONTAINER BELOW HEADER -->
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cs-content">
                        <!-- Note: cs-content is called by Javascript -->

                        <!-- 5TH SUNDAY CLICKABLE RESOURCES OUTER CONTAINER -->
                        <div class="cs-bible-accordion-content">

                            <!-- VIDEO RECORDING CONTAINER -->
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b cs-course-border-t">

                                <a href="get-resource/lnt-b-s5-video----5sun-lnt-b" class="flex flex-row mt-0">
                                    <img src="/src/assets/video-icon.svg" class="inline-block w-8 h-8">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Video of Fifth Sunday of Lent
                                    </span>
                                </a>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b">
                                ...
                                <a href="get-resources/lnt-b-s5-study-questions---5sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Study Questions
                                    </span>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100">
                                ...
                                <a href="get-resource/lnt-b-s5-short-notes---5sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Short Notes
                                    </span>
                        ...
                        </div> <!-- END OF 5TH SUNDAY CLICKABLE RESOURCES OUTER CONTAINER -->

                    </div> <!-- END OF 5TH SUNDAY CONTAINER BELOW HEADER -->

                </div> <!-- END OF 5TH SUNDAY OUTER CONTAINER -->

                <!-- 6TH SUNDAY OUTER CONTAINER -->
                <div class="cs-bible-area-box">
                    ...
                    <button type="button" onclick="toggleAccordion(this)"
                        ...
                        <div>
                            <div class=" text-cs-blue-light">Sixth Sunday of Lent (Year&nbsp;B) - Mk&nbsp;11:1-10</div>
                            <div class="mt-2 italic cs-fs-sm text-cs-grey">
                    ...
                    <!-- 6TH SUNDAY CONTAINER BELOW HEADER -->
                    <div class="overflow-hidden transition-all duration-300 ease-in-out cs-content">
                        <!-- Note: cs-content is called by Javascript -->

                        <!-- 6TH SUNDAY CLICKABLE RESOURCES OUTER CONTAINER -->
                        <div class="cs-bible-accordion-content">

                            <!-- VIDEO RECORDING CONTAINER -->
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b cs-course-border-t">

                                <a href="get-resource/lnt-b-s6-video----6sun-lnt-b" class="flex flex-row mt-0">
                                    <img src="/src/assets/video-icon.svg" class="inline-block w-8 h-8">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Video of Sixth Sunday of Lent
                                    </span>
                                </a>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100 cs-course-border-b">
                                ...
                                <a href="get-resources/lnt-b-s6-study-questions---6sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Study Questions
                                    </span>
                            ...
                            <div class="flex flex-col items-start px-8 pt-6 pb-6 hover:bg-gray-100">
                                ...
                                <a href="get-resource/lnt-b-s6-short-notes---6sun-lnt-b" class="flex flex-row mt-4">
                                    <img src="/src/assets/pdf-icon.svg" class="inline-block w-8 h-8" alt="Pdf">
                                    <span class="ml-5 font-semibold cs-fs-base">
                                        Short Notes
                                    </span>
                        ...
                        </div> <!-- END OF 6TH SUNDAY CLICKABLE RESOURCES OUTER CONTAINER -->

                    </div> <!-- END OF 6TH SUNDAY CONTAINER BELOW HEADER -->

                </div> <!-- END OF 6TH SUNDAY OUTER CONTAINER -->
