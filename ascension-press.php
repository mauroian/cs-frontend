...
<main class="cs-main pb-0">
    <div class="cs-main-div">
        <!-- 'Title' container -->
        <div class="flex flex-col flex-wrap items-center justify-center w-full text-white h-36 sm:h-44 md:h-96 cs-bg-ascension-press">
            <div class="w-full leading-tight max-w-[1000px] text-center px-2 pb-3">
                <h2 class="font-serif cs-fs-lg md:cs-fs-4xl sm:cs-fs-xl italic">The <b>resources</b> that have changed
                    the way &nbsp;
                    <b>Catholics</b> read the <b>Bible.</b></h2>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper-dark">
            <div class="w-full max-w-[1000px] my-5 flex flex-col gap-4">
                ...
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-red-shade">Ascension Press
                    Resources</h2>
                <span class="tracking-wide font-semibold text-cs-red-shade sm:cs-fs-xl cs-fs-base">Study tools recommended by Mauro during his courses.</span>
            </div>
        </div>
            ...
            <div class="w-full max-w-[1000px] my-7 flex flex-col ">
                <div class="cs-ascension-box-text">
                    ...
                    <p class="tracking-wide ">However, if you follow Mauro's <span
                                class="text-cs-blue-light font-bold">Bible Timeline Course</span>, we highly recommend
                        getting the <span class="text-cs-blue-light font-bold">Bible Timeline Chart</span>. It serves as
                        an
                    ...
                    <p class="tracking-wide ">And for those of you who want to make a great spiritual
                        investment
                        for your life, we recommend buying also the book <span class="text-cs-blue-light font-bold">Walking With God: a journey through the Bible.</span>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper-dark">
            <div class="w-full max-w-[1000px] my-5 flex flex-col gap-6">
                ...
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-blue-main font-bold">The Bible Timeline
                    Chart</h2>
                <span class="tracking-wide font-semibold text-cs-grey sm:cs-fs-xl cs-fs-base">By Jeff Cavins</span>
                ...
                <div class="cs-ascension-box-text">
                    <p class="tracking-wide ">This chart is invaluable! It's <span
                                class="text-cs-blue-light font-semibold">the cornerstone of the Bible
                    ...
                    <p class="tracking-wide ">During the online sessions, Mauro teaches by displaying on the
                        ...
                        <span class="text-cs-blue-light font-semibold">it is highly recommend that that you buy this chart</span>.
                        It will help you to make the most out of
                        the course and when reading the Bible for the rest of your life!</p>
                </div>
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper">
            <div class="w-full max-w-[1000px] my-10 flex flex-col gap-6">
                ...
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-blue-main font-bold">Walking with God: A
                    Journey Through the Bible</h2>
                <span class="tracking-wide font-semibold text-cs-grey sm:cs-fs-xl cs-fs-base">By Tim Gray & Jeff Cavins</span>
                ...
                <div class="cs-ascension-box-text">
                    <p class="tracking-wide ">This book is simply exceptional and has changed the lives of
                        many.
                        <span class="text-cs-blue-light font-semibold">It has 12 chapters, one for each of the 12 periods of the Bible Timeline chart.</span>
                        By simply reading this book you will cover the Biblical Narrative from start to finish.</p>
                </div>
                <div class="flex flex-row items-center justify-start w-full gap-2 md:gap-8">
                    <button class="cs-support-us-button bg-cs-red-medium">Buy</button>
                    <button class="cs-ascension-recommended">
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper-dark">
            <div class="w-full max-w-[1000px] my-5 flex flex-col gap-6">
                ...
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-blue-main font-bold">The Great Adventure
                    Bible</h2>
                <span class="tracking-wide font-semibold text-cs-grey sm:cs-fs-xl cs-fs-base">Ascension Press</span>
                <div class="flex flex-row gap-2 md:gap-14 ">
                ...
                <div class="cs-ascension-box-text">
                    <p>
                        This unique Bible features the Bible Timeline® methodology embedded throughout. <span
                                class="text-cs-blue-light font-semibold">Each page is color-coded according to the 12 periods of the Bible Timeline Chart,</span>
                    ...
                    <p>
                        ...
                        within the Bible itself. As Jeff Cavins puts it: <span class="text-cs-blue-light font-semibold">"The Bible that teaches you how to read it."</span>
                    </p>
                    <p>
                ...
                <div class="grid grid-cols-2 gap-6 gap-y-8 my-8">
                ...
                <div class="flex flex-col gap-6">
                    <p class="tracking-wide md:tracking-wider uppercase font-thin cs-fs-xs md:cs-fs-2sm text-cs-grey">
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper">
            <div class="w-full max-w-[1000px] my-5 flex flex-col gap-6">
                ...
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-blue-main font-bold">The Bible Timeline: the
                ...
                <div class="cs-ascension-box ">
                    <div class="cs-ascension-box-text">
                        ...
                        <ul class="list-none list-inside text-cs-grey uppercase">
                            <li>12 DVD Set</li>
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper-dark">
            <div class="w-full max-w-[1000px] my-5 flex flex-col gap-6">
                ...
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-blue-main font-bold">Unlocking the Mystery of
                    the Bible</h2>
                <span class="tracking-wide font-bold text-cs-grey sm:cs-fs-xl cs-fs-base">By Jeff Cavins</span>
                <div class="cs-ascension-box ">
                    <div class="cs-ascension-box-text">
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper">
            <div class="w-full max-w-[1000px] my-10 flex flex-col gap-2 md:gap-6">
                <span class="tracking-widest uppercase sm:cs-fs-xs cs-fs-xs text-cs-blue-main">BOOK</span>
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-blue-main font-bold">A Biblical Walk through
                    the Mass</h2>
                <span class="tracking-wide font-bold text-cs-grey sm:cs-fs-xl cs-fs-base">By Edward Sri</span>

                <div class="cs-ascension-box justify-between">
                    <div class="cs-ascension-box-text md:my-8 md:max-w-[50%]">
                        ...
                        <img src="/src/assets/ascension-press/biblical-walk-mass-front.jpg"
                             alt="A Biblical Walk through the Mass" class="w-auto max-w-80 md:-mt-14 h-auto">
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col items-center w-full p-5 sm:p-10 bg-cs-paper-dark">
            <div class="w-full max-w-[1000px] my-10 flex flex-col gap-6">
                <span class="tracking-widest uppercase sm:cs-fs-xs cs-fs-xs text-cs-grey text-center">buy</span>
                <h2 class="font-serif italic cs-fs-xl sm:cs-fs-3xl text-cs-red-shade text-center">How to order these
                    Resources</h2>
                <div class="cs-ascension-box-text">
